...
import CarouselComponent1 from "../../Component/Card/CarouselComponent1";
    ...
    return (
      <Paper className={classes["wrapper-paper"]}>
        <div className={classes.wrapper}>
          <CarouselComponent1 items={bookTriple} />
        </div>
      </Paper>
    );
  });

  return <Carousel indicators={false}>{carouselItems}</Carousel>;
}
