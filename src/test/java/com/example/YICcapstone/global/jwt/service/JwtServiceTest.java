package com.example.YICcapstone.global.jwt.service;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.interfaces.DecodedJWT;
import com.example.YICcapstone.YiCcapstoneApplication;
...
import com.example.YICcapstone.global.jwt.JwtService;
...
@SpringBootTest
@Transactional
@ContextConfiguration(classes =  YiCcapstoneApplication.class)
class JwtServiceTest {
    ...
    @Value("#{system['jwt.access.header']}")
    private String accessHeader;
    @Value("#{system['jwt.refresh.header']}")
    ...
    public void init() {
        Member member = Member.builder().username(username).password("1234567890")
                .name("Member1").nickname("NickName1").birth("19990101").sex(1).role(Role.USER).build();
